...
>
> **Universal Alignment:** Invariants in [.kramak/ROUTER.md](file:///d:/dev/pro/kramak/.kramak/ROUTER.md) and schemas in [.kramak/schemas/work-item.schema.json](file:///d:/dev/pro/kramak/.kramak/schemas/work-item.schema.json) strictly govern all artifacts authored under this contract.
