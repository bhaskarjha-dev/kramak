...
> **Purpose:** Comprehensive rule catalog extracted from `spec/PLANNER.md`, `spec/PRINCIPLES.md`, and `spec/BOOTSTRAP.md`.
...
### 1. Bounded Autonomy & Strategic Mindset (`spec/PLANNER.md` lines 1–40)
...
### 2. Grounded Planning & Capability Gate (`spec/PLANNER.md` lines 43–72)
...
### 3. Empty Workspace Guard (`spec/PLANNER.md` lines 76–82)
...
### 4. Project Discovery & Structure Mapping (`spec/PLANNER.md` lines 83–121)
...
### 5. Context Reading & Anti-Anchoring Bias (`spec/PLANNER.md` lines 123–151)
...
### 6. INBOX Processing (`spec/PLANNER.md` lines 152–163)
...
### 7. Strategic Reorientation (`spec/PLANNER.md` lines 165–226)
...
### 8. Strategic Vision (5 Lenses) (`spec/PLANNER.md` lines 228–314)
...
### 9. Perspective Selection (PERCEIVE $\rightarrow$ REASON $\rightarrow$ DECIDE) (`spec/PLANNER.md` lines 315–422)
...
### 10. Prioritization by productPhase & Modification Boundaries (`spec/PLANNER.md` lines 423–537)
...
### 11. Batch Planning & Sizing (`spec/PLANNER.md` lines 538–614)
...
### 12. Branch Management (`spec/PLANNER.md` lines 616–628)
...
### 13. Work Item Specification & Detail Scaling (`spec/PLANNER.md` lines 630–800)
...
### 14. Self-Audit Checklist (`spec/PLANNER.md` lines 802–828)
...
### 15. Session Continuity & Model Handoff (`spec/PLANNER.md` lines 830–903)
...
### 16. Executor Audit Review & Circuit Breaker (`spec/PLANNER.md` lines 905–943)
...
### 17. Edge Case Handling Table (`spec/PLANNER.md` lines 945–966)
...
### 18. Development Principles (`spec/PRINCIPLES.md` lines 1–312)
...
### 19. Bootstrap & Governance Infrastructure (`spec/BOOTSTRAP.md`, `FOUNDING-ARCHITECTURE.md`, Research Amendments)
