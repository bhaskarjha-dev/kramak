...
1. Read [.kramak/state.json](file:///d:/dev/pro/kramak/.kramak/state.json) (if missing, initialize with `phase: "bootstrap"`).
2. Read [.kramak/ROUTER.md](file:///d:/dev/pro/kramak/.kramak/ROUTER.md) and follow the routing table for `state.phase`.
3. Follow all invariants in [.kramak/ROUTER.md](file:///d:/dev/pro/kramak/.kramak/ROUTER.md) and universal instructions in [.kramak/AGENTS.md](file:///d:/dev/pro/kramak/.kramak/AGENTS.md).
